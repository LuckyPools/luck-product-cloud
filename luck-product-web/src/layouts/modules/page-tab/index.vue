...
<script>
import ChromeTab from '@/layouts/modules/page-tab/chrome-tab/index.vue';
import ButtonTab from '@/layouts/modules/page-tab/button-tab/index.vue';
import SvgClose from "@/layouts/modules/page-tab/svg-close/index.vue";
