...
//		return DateFormatUtils.format(new Date(), pattern);
    ...
    /**
     * 获取一天的最后时间（如：2019-3-3 23:59:59.999）
     *
     * @param date 日期
     * @return
     */
     ...
     * @return
     */
    public static int getBetweenYear(Date beginDate, Date endDate) {
        Calendar cal2 = new GregorianCalendar();
        cal2.setTime(beginDate);
        Calendar cal1 = new GregorianCalendar();
        cal1.setTime(endDate);
        int c = cal1.get(Calendar.YEAR) - cal2.get(Calendar.YEAR);
        if (cal1.get(Calendar.MONTH) < cal2.get(Calendar.MONTH) || (cal1.get(Calendar.MONTH) == cal2.get(Calendar.MONTH) && cal1.get(Calendar.DATE) < cal2.get(Calendar.DATE))) {
            c--;
        }
        return c;
    }
     ...
     * @return
     */
    public static int getBetweenMonth(Date beginDate, Date endDate) {
        Calendar cal2 = new GregorianCalendar();
        cal2.setTime(beginDate);
        Calendar cal1 = new GregorianCalendar();
        cal1.setTime(endDate);
